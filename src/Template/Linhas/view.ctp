      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <dd><?= h($linha->descricao) ?></dd>
            <dt scope="row"><?= __('Checklist') ?></dt>
            <dd><?= $linha->has('checklist') ? $this->Html->link($linha->checklist->id, ['controller' => 'Checklists', 'action' => 'view', $linha->checklist->id]) : '' ?></dd>
            <dt scope="row"><?= __('Id') ?></dt>
            <dd><?= $this->Number->format($linha->id) ?></dd>
          </dl>
        </div>
      </div>
    </div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          ...
          <table class="table table-hover">
              ...
              <?php foreach ($linha->respostas as $respostas): ?>
              <tr>
