...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg" style="padding: 0 20px 0px 20px;"><?php echo __('A senha padrão deve ser alterada.') ?></p>
  ...
  <script>
    ...
    $('#verSenhas').on('ifChecked', function(e){
      $('.campoSenhaU').prop('type','text');
    });
    $('#verSenhas').on('ifUnchecked', function(e){
      $('.campoSenhaU').prop('type','password');
    });
  </script>
</body>
</html>